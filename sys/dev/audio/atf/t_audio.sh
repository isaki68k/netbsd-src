...
open_audioctl_sticky_body() { h_audio open_audioctl_sticky }
...
AUDIO_SETFD_RDONLY_body() { h_audio AUDIO_SETFD_RDONLY }

atf_test_case AUDIO_SETFD_WRONLY
AUDIO_SETFD_WRONLY_head() { }
AUDIO_SETFD_WRONLY_body() { h_audio AUDIO_SETFD_WRONLY }
...
AUDIO_ERROR_RDONLY_body() { h_audio AUDIO_ERROR_RDONLY }

atf_test_case AUDIO_ERROR_WRONLY
AUDIO_ERROR_WRONLY_head() { }
AUDIO_ERROR_WRONLY_body() { h_audio AUDIO_ERROR_WRONLY }
