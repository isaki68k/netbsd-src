...
#define AUDIO_ENC_K_RAW			0
#define AUDIO_ENC_K_ULAW8		1
#define AUDIO_ENC_K_ALAW8		2
#define AUDIO_ENC_K_S8			3
#define AUDIO_ENC_K_S16LE		4
#define AUDIO_ENC_K_S24LE		5
#define AUDIO_ENC_K_S32LE		6
#define AUDIO_ENC_K_S64LE		7	// internal2 only
#define AUDIO_ENC_K_S16BE		8
#define AUDIO_ENC_K_S24BE		9
#define AUDIO_ENC_K_S32BE		10
#define AUDIO_ENC_K_S64BE		11	// internal2 only
#define AUDIO_ENC_K_U8			12
#define AUDIO_ENC_K_U16LE		13
#define AUDIO_ENC_K_U24LE		14
#define AUDIO_ENC_K_U32LE		15
#define AUDIO_ENC_K_U64LE		16	// reserved
#define AUDIO_ENC_K_U16BE		17
#define AUDIO_ENC_K_U24BE		18
#define AUDIO_ENC_K_U32BE		19
#define AUDIO_ENC_K_U64BE		20	// reserved
#define AUDIO_ENC_K_MSM6258ADPCM4	6258

#if AUDIO_INTERNAL_BITS == 16
#if BYTE_ORDER == LITTLE_ENDIAN
#define AUDIO_ENC_K_INTERNAL	AUDIO_ENC_K_S16LE
#define AUDIO_ENC_K_INTERNAL2	AUDIO_ENC_K_S32LE
#else
#define AUDIO_ENC_K_INTERNAL	AUDIO_ENC_K_S16BE
#define AUDIO_ENC_K_INTERNAL2	AUDIO_ENC_K_S32BE
#endif
#else
#if BYTE_ORDER == LITTLE_ENDIAN
#define AUDIO_ENC_K_INTERNAL	AUDIO_ENC_K_S32LE
#define AUDIO_ENC_K_INTERNAL2	AUDIO_ENC_K_S64LE
#else
#define AUDIO_ENC_K_INTERNAL	AUDIO_ENC_K_S32BE
#define AUDIO_ENC_K_INTERNAL2	AUDIO_ENC_K_S64BE
#endif
#endif
